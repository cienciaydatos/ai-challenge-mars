...
class AnomalyConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + anomaly ( crater and sand-dune)
...
class AnomalyDataset(utils.Dataset):
    ...
    def load_anomaly(self, dataset_dir, subset):
        """Load a subset of the Anomaly dataset.
        ...
        for a in annotations:
            ...
            # To be noted, the source will be the name category to which the classification is
            # going on hence in the VIA annotator, the class name is anomaly and the classes were
            # "crater", "sand-dune"
            self.add_image(
                "anomaly",
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for i, p in enumerate(info["polygons"]):
            ...
            mask[rr, cc, i] = 1
        # Transforming the class id to numpy array.
